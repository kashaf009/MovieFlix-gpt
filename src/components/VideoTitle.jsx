...
const VideoTitle = ({title,overview}) => {
  return (
    <div className='pt-55 md:pt-50 w-[80%] md:w-[50%] pl-8 md:pl-20 text-white absolute z-10 h-screen aspect-video  bg-gradient-to-r from-black '>
      ...
      <button className="bg-gray-700 px-3 py-2 md:px-6 md:py-1.5 hover:bg-gray-900 text-lg text-white rounded-md font-semibold">▶︎ Play</button>
